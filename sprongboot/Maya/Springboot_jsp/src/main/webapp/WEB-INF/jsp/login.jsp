...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../resources/static/css/body.css"/>
    ...
    <style type="text/css">
        ...
        #content form input[type="password"] {
            ...
            background: #eae7e7 url(../../../resources/static/images/8bcLQqF.png) no-repeat;
        ...
        .button a {
            background: url(../../../resources/static/images/8bcLQqF.png) 0 -112px no-repeat;
            color: #7E7E7E;
            font-size: 17px;
        ...
        body{
            background:url(../../../resources/static/images/cloud.jpg) 0 bottom repeat-x  #049ec4;
